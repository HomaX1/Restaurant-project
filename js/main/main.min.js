...
!function(){"use strict";var e="";window.location.href;header.innerHTML=MyApp.templates.header(),footer.innerHTML=MyApp.templates.footer(),home.innerHTML=MyApp.templates.home(),headerFunctions.headerRender(),homeFunctions.homeRender();var n={renderPage:function(e,n,a){$("#content").children().empty(),e.innerHTML=a?n({menu:a}):n()},createMenu:function(a){e=this;var t=a.filter(function(n){return n.category===e?n:"menu-link"===e?n:void 0});n.renderPage(menu,MyApp.templates.menu,t),menuFunctions.listShow(t)},pageNavigation:function(){$("body").on("click",".navigation, .footer-navigation, .main-header__logo, .menu-icons",function(e){var a=e.target.id;switch(a){case"home-link":case"logo-link":n.renderPage(home,MyApp.templates.home),homeFunctions.homeRender(),"#";break;case"menu-link":$.get("/menu.json",n.createMenu.bind(a)),"#menu";break;case"dishes":$.get("/menu.json",n.createMenu.bind(a)),"#menu/dishes";break;case"soups":$.get("/menu.json",n.createMenu.bind(a)),"#menu/soups";break;case"salads":$.get("/menu.json",n.createMenu.bind(a)),"#menu/salads";break;case"desserts":$.get("/menu.json",n.createMenu.bind(a)),"#menu/desserts";break;case"beverages":$.get("/menu.json",n.createMenu.bind(a)),"#menu/beverages";break;case"reservation-link":n.renderPage(reservation,MyApp.templates.reservation),"#reservation";break;case"gallery-link":n.renderPage(gallery,MyApp.templates.gallery),"#gallery";break;case"contacts-link":n.renderPage(contacts,MyApp.templates.contacts),"#contacts"}})}};n.pageNavigation()}();
var sortInfo=".sorts-info",sortText=".sorts-info__text",sortList=".sorts-list",menuFunctions={listShow:function(t){$(sortInfo).click(function(){$(sortList).fadeIn(),menuFunctions.selectOption(t)})},selectOption:function(t){$(sortList).click(function(e){$(sortList).fadeOut();var n=e.target.innerText;switch(n){case"From Cheap To Expensive":t.sort(menuFunctions.increaseSort),menu.innerHTML=MyApp.templates.menu({menu:t}),$(sortText).text(n),menuFunctions.listShow(t);break;case"From Expensive To Cheap":t.sort(menuFunctions.decreaseSort),menu.innerHTML=MyApp.templates.menu({menu:t}),$(sortText).text(n),menuFunctions.listShow(t)}}),$("body").mouseup(function(t){0===$(".sorts").has(t.target).length&&$(sortList).fadeOut()})},increaseSort:function(t,e){var n=parseFloat(t.price),o=parseFloat(e.price);return n>o?1:n<o?-1:void 0},decreaseSort:function(t,e){var n=parseFloat(t.price),o=parseFloat(e.price);return n>o?-1:n<o?1:void 0}};