...
!function(){"use strict";var e="";window.location.href;header.innerHTML=MyApp.templates.header(),footer.innerHTML=MyApp.templates.footer(),home.innerHTML=MyApp.templates.home(),headerFunctions.headerRender(),homeFunctions.homeRender();var n={renderPage:function(e,n,a){$("#content").children().empty(),e.innerHTML=a?n({menu:a}):n()},createMenu:function(a){e=this;var t=a.filter(function(n){return n.category===e?($(".menu-icons__link").addClass("activeCategory"),n):"menu-link"===e?n:void 0});n.renderPage(menu,MyApp.templates.menu,t),"menu-link"===e?$(".menu-icons__link_all").addClass("activeCategory"):$(".menu-icons__link_"+e).addClass("activeCategory"),menuFunctions.listShow(t)},pageNavigation:function(){$("body").on("click",".navigation, .footer-navigation, .main-header__logo, .menu-icons",function(e){var a=e.target.id;switch(a){case"home-link":case"logo-link":n.renderPage(home,MyApp.templates.home),homeFunctions.homeRender(),"#";break;case"menu-link":$.get("/menu.json",n.createMenu.bind(a)),"#menu";break;case"dishes":$.get("/menu.json",n.createMenu.bind(a)),"#menu/dishes";break;case"soups":$.get("/menu.json",n.createMenu.bind(a)),"#menu/soups";break;case"salads":$.get("/menu.json",n.createMenu.bind(a)),"#menu/salads";break;case"desserts":$.get("/menu.json",n.createMenu.bind(a)),"#menu/desserts";break;case"beverages":$.get("/menu.json",n.createMenu.bind(a)),"#menu/beverages";break;case"reservation-link":n.renderPage(reservation,MyApp.templates.reservation),"#reservation";break;case"gallery-link":n.renderPage(gallery,MyApp.templates.gallery),"#gallery";break;case"contacts-link":n.renderPage(contacts,MyApp.templates.contacts),"#contacts"}})}};n.pageNavigation()}();
